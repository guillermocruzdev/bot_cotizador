...
/**
 * 404 global de la app (FASE 7). Renderiza dentro del root layout para las
 * URLs que no matchean ninguna ruta (el route group (marketing)/not-found.tsx
 * cubre solo los notFound() lanzados dentro de páginas de la vitrina).
 */
  ...
  return (
    <div className="relative isolate flex min-h-dvh flex-col items-center justify-center gap-6 overflow-hidden bg-night-900 px-6 text-center text-white">
      ...
      <p className="max-w-md text-slate-300">
        ...
        puede existir: cotiza con Alex en 3 minutos o escríbenos.
      </p>
