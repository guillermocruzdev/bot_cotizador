...
> | URL Vercel | https://nexora-telemedicina.vercel.app |
> | Repo GitHub | https://github.com/Nexora/pack-telemedicina |
...
> Este pack no es genérico: está afinado para un proyecto de **Portal de salud / telemedicina**. Toda decisión de UX, contenido, datos y QA debe alinearse con esto.

**🎭 Rol que conduce el proyecto:** Consultor de salud digital + arquitecto de portal clínico

**🥇 Conversión #1 (el objetivo comercial):** Convertir visitas en CONSULTAS agendadas y atendidas: el paciente agenda, llena su expediente y hace videollamada — con recetas electrónicas y expediente digital para el médico.
...
PROYECTO: Portal de salud / telemedicina para Clínica VidaSana · Nivel Avanzado.
TIPO DE PÁGINA: portal de salud / telemedicina (expediente, videollamada y recetas) para clínica / consultorio médico.
...
SERVICIOS/OFERTA A MOSTRAR: consultas generales y especialidades.
ESTRUCTURA ACORDADA CON EL CLIENTE: Inicio, Servicios médicos, Agendar consulta, Expediente.
NEGOCIO: "Quiero un portal para que mis pacientes agenden consulta en línea con videollamada y expediente".
...
- Negocio: Portal de salud / telemedicina · Giro: Clínica / consultorio médico.
- Servicios/oferta: consultas generales y especialidades.
- Descripción del cliente: "Quiero un portal para que mis pacientes agenden consulta en línea con videollamada y expediente".
- Sin referencia de estilo definida.
- Presupuesto: 45000 · Entrega: para el próximo mes.
...
- **Colores de marca**: 2-4 colores (hex) que usa el negocio (logo, redes, local); si no los hay, propón una paleta coherente con el giro **Clínica / consultorio médico** y márcala como propuesta a validar.
...
- **Mensaje de venta:** Tu paciente agenda, se atiende por videollamada y llevas su expediente digital.
...
- consultas generales y especialidades — con descripción breve, beneficios y CTA de contacto.

### Sitemap / estructura acordada con el cliente
El cliente describió la estructura así: "Inicio, Servicios médicos, Agendar consulta, Expediente". Asegúrate de que la navegación y las secciones reflejen esta estructura de forma completa y coherente.
...
Crea `docs/ux/voice-tone.md`: cómo suena la marca según el giro **Clínica / consultorio médico** y el análisis (Tu paciente agenda, se atiende por videollamada y llevas su expediente digital.):
