> #️⃣ **REGISTRO · PK-013** — identifica este PACK en Vercel / GitHub
>
> | Campo | Valor |
> |---|---|
> | Código | `PK-013` |
...
| Tiempo estimado | 12-20 días de desarrollo |
...
> Este pack no es genérico: está afinado para un proyecto de **Cotizador / presupuesto en línea**. Toda decisión de UX, contenido, datos y QA debe alinearse con esto.

**🎭 Rol que conduce el proyecto:** Director de producto del cotizador + optimizador de conversión de servicios

**🥇 Conversión #1 (el objetivo comercial):** Convertir visitas en COTIZACIONES calificadas: el cliente describe lo que necesita, el sistema calcula el precio solo y el negocio recibe el aviso — el bot que usa el cliente, pero para su negocio.
...
PROYECTO: Cotizador / presupuesto en línea para Iván Contreras · Nivel Profesional.
TIPO DE PÁGINA: cotizador / presupuesto en línea para negocio de servicios que cotiza.
...
SERVICIOS/OFERTA A MOSTRAR: mantenimiento industrial y reparaciones.
ESTRUCTURA ACORDADA CON EL CLIENTE: Inicio, Cotiza aquí, Servicios, Contacto.
NEGOCIO: "Quiero que mis clientes me pidan cotización en línea con cálculo automático".
...
- Negocio: Cotizador / presupuesto en línea · Giro: Negocio de servicios que cotiza.
- Servicios/oferta: mantenimiento industrial y reparaciones.
- Descripción del cliente: "Quiero que mis clientes me pidan cotización en línea con cálculo automático".
- Sin referencia de estilo definida.
- Presupuesto: 20000 a 25000 · Entrega: para el próximo mes.
...
Incorpora la estructura acordada con el cliente: "Inicio, Cotiza aquí, Servicios, Contacto".
...
Dibuja (en Markdown con flechas) el flujo de cada tarea crítica del giro **Cotizador / presupuesto en línea**:
...
- **Colores de marca**: 2-4 colores (hex) que usa el negocio (logo, redes, local); si no los hay, propón una paleta coherente con el giro **Negocio de servicios que cotiza** y márcala como propuesta a validar.
...
- **Mensaje de venta:** Tus clientes piden su presupuesto en línea y el sistema calcula el precio solo.
...
### Secciones a construir (Cotizador / presupuesto en línea — 4 bloques)
- / — Página de inicio: hero con propuesta de valor, servicios, beneficios, testimonios (opcional), CTA de contacto.
- /#servicios — Sección de servicios anclada.
- /#contacto — Formulario de contacto + datos de la empresa + mapa (si aplica).
- /aviso-de-privacidad — Página legal obligatoria en México (LFPDPPP).
...
- mantenimiento industrial y reparaciones — con descripción breve, beneficios y CTA de contacto.

### Sitemap / estructura acordada con el cliente
El cliente describió la estructura así: "Inicio, Cotiza aquí, Servicios, Contacto". Asegúrate de que la navegación y las secciones reflejen esta estructura de forma completa y coherente.
...
Crea `docs/ux/voice-tone.md`: cómo suena la marca según el giro **Negocio de servicios que cotiza** y el análisis (Tus clientes piden su presupuesto en línea y el sistema calcula el precio solo.):
...
```sql
-- COTIZADOR — esquema base (convención de tipos; ajustar en kickoff)
