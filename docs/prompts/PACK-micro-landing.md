> #️⃣ **REGISTRO · PK-004** — identifica este PACK en Vercel / GitHub
>
> | Campo | Valor |
> |---|---|
> | Código | `PK-004` |
...
> Este pack no es genérico: está afinado para un proyecto de **Micro-landing promocional (una sola oferta)**. Toda decisión de UX, contenido, datos y QA debe alinearse con esto.
...
PROYECTO: Micro-landing promocional (una sola oferta) para PromoTech Studio · Nivel Básico.
TIPO DE PÁGINA: landing / página de presentación para negocio local / campaña promocional.
...
SERVICIOS/OFERTA A MOSTRAR: promoción de lanzamiento de un curso.
ESTRUCTURA ACORDADA CON EL CLIENTE: Promo, Oferta, Formulario, Contacto.
NEGOCIO: "Quiero una micro-landing para una promoción o campaña con un solo objetivo: captar contactos".
...
- Negocio: Micro-landing promocional (una sola oferta) · Giro: Negocio local / campaña promocional.
- Servicios/oferta: promoción de lanzamiento de un curso.
- Descripción del cliente: "Quiero una micro-landing para una promoción o campaña con un solo objetivo: captar contactos".
...
Incorpora la estructura acordada con el cliente: "Promo, Oferta, Formulario, Contacto".
...
- **Colores de marca**: 2-4 colores (hex) que usa el negocio (logo, redes, local); si no los hay, propón una paleta coherente con el giro **Negocio local / campaña promocional** y márcala como propuesta a validar.
...
- **Mensaje de venta:** Una sola página enfocada en UNA oferta: el visitante actúa o se va.
...
### Secciones a construir (Micro-landing promocional (una sola oferta) — 4 bloques)
- / — Página de inicio: hero con propuesta de valor, servicios, beneficios, testimonios (opcional), CTA de contacto.
- /#servicios — Sección de servicios anclada.
- /#contacto — Formulario de contacto + datos de la empresa + mapa (si aplica).
- /aviso-de-privacidad — Página legal obligatoria en México (LFPDPPP).
...
- promoción de lanzamiento de un curso — con descripción breve, beneficios y CTA de contacto.

### Sitemap / estructura acordada con el cliente
El cliente describió la estructura así: "Promo, Oferta, Formulario, Contacto". Asegúrate de que la navegación y las secciones reflejen esta estructura de forma completa y coherente.
...
Crea `docs/ux/voice-tone.md`: cómo suena la marca según el giro **Negocio local / campaña promocional** y el análisis (Una sola página enfocada en UNA oferta: el visitante actúa o se va.):
