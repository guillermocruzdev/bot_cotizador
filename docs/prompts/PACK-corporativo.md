...
| Tiempo estimado | 10-18 días de desarrollo |
...
> Este pack no es genérico: está afinado para un proyecto de **Sitio corporativo (varias páginas)**. Toda decisión de UX, contenido, datos y QA debe alinearse con esto.

**🎭 Rol que conduce el proyecto:** Consultor de presencia digital + arquitecto de contenido multi-página

**🥇 Conversión #1 (el objetivo comercial):** Convertir visitas en CONFIANZA y CONTACTO: varias páginas (quienes somos, servicios, proyectos, contacto) que posicionen a la empresa como seria y den el siguiente paso fácil.
...
PROYECTO: Sitio corporativo (varias páginas) para Grupo Constructor MX · Nivel Profesional.
TIPO DE PÁGINA: sitio corporativo (varias páginas) para constructora / arquitecto.
...
SERVICIOS/OFERTA A MOSTRAR: construcción residencial y comercial.
ESTRUCTURA ACORDADA CON EL CLIENTE: Inicio, Nosotros, Servicios, Proyectos, Contacto.
NEGOCIO: "Quiero una página para mi constructora con quienes somos, proyectos y contacto, varias secciones".
...
- Negocio: Sitio corporativo (varias páginas) · Giro: Constructora / arquitecto.
- Servicios/oferta: construcción residencial y comercial.
- Descripción del cliente: "Quiero una página para mi constructora con quienes somos, proyectos y contacto, varias secciones".
- Sin referencia de estilo definida.
- Presupuesto: 20000 · Entrega: para el próximo mes.
...
Incorpora la estructura acordada con el cliente: "Inicio, Nosotros, Servicios, Proyectos, Contacto".
...
Dibuja (en Markdown con flechas) el flujo de cada tarea crítica del giro **Sitio corporativo (varias páginas)**:
...
- **Colores de marca**: 2-4 colores (hex) que usa el negocio (logo, redes, local); si no los hay, propón una paleta coherente con el giro **Constructora / arquitecto** y márcala como propuesta a validar.
...
- **Mensaje de venta:** Posiciona a tu empresa como seria con varias páginas y contenido real.
...
### Secciones a construir (Sitio corporativo (varias páginas) — 4 bloques)
- / — Página de inicio: hero con propuesta de valor, servicios, beneficios, testimonios (opcional), CTA de contacto.
- /#servicios — Sección de servicios anclada.
- /#contacto — Formulario de contacto + datos de la empresa + mapa (si aplica).
- /aviso-de-privacidad — Página legal obligatoria en México (LFPDPPP).
...
- construcción residencial y comercial — con descripción breve, beneficios y CTA de contacto.

### Sitemap / estructura acordada con el cliente
El cliente describió la estructura así: "Inicio, Nosotros, Servicios, Proyectos, Contacto". Asegúrate de que la navegación y las secciones reflejen esta estructura de forma completa y coherente.
...
Crea `docs/ux/voice-tone.md`: cómo suena la marca según el giro **Constructora / arquitecto** y el análisis (Posiciona a tu empresa como seria con varias páginas y contenido real.):
...
```sql
-- CORPORATIVO — esquema base (convención de tipos; ajustar en kickoff)
