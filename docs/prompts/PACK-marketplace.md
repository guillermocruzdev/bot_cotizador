...
| Tiempo estimado | 30-45 días de desarrollo |
...
> Este pack no es genérico: está afinado para un proyecto de **Marketplace multi-vendedor (comisión por venta)**. Toda decisión de UX, contenido, datos y QA debe alinearse con esto.
...
PROYECTO: Marketplace multi-vendedor (comisión por venta) para Mercado Local · Nivel Avanzado.
...
NEGOCIO: "Quiero montar un marketplace con varios vendedores que publiquen y vendan, y yo cobrar comisión por venta".
...
- Negocio: Marketplace multi-vendedor (comisión por venta) · Giro: Empresa / operación (plataforma a medida).
- Servicios/oferta: productos de artesanos y pymes.
- Descripción del cliente: "Quiero montar un marketplace con varios vendedores que publiquen y vendan, y yo cobrar comisión por venta".
- Sin referencia de estilo definida.
- Presupuesto: 80000 · Entrega: para el próximo mes.
...
- **Mensaje de venta:** Muchos vendedores publican y venden; tú cobras comisión con split de pagos.
...
- productos de artesanos y pymes — con descripción breve, beneficios y CTA de contacto.
...
Crea `docs/ux/voice-tone.md`: cómo suena la marca según el giro **Empresa / operación (plataforma a medida)** y el análisis (Muchos vendedores publican y venden; tú cobras comisión con split de pagos.):
