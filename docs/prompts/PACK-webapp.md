> #️⃣ **REGISTRO · PK-020** — identifica este PACK en Vercel / GitHub
>
> | Campo | Valor |
> |---|---|
> | Código | `PK-020` |
...
| Tiempo estimado | 15-30 días de desarrollo |
...
> Este pack no es genérico: está afinado para un proyecto de **Plataforma / sistema web a medida**. Toda decisión de UX, contenido, datos y QA debe alinearse con esto.

**🎭 Rol que conduce el proyecto:** Arquitecto de software + product manager de sistemas

**🥇 Conversión #1 (el objetivo comercial):** Automatizar el proceso del cliente: login por roles, operaciones CRUD sobre sus módulos, trazabilidad y reportes accionables.
...
PROYECTO: Plataforma / sistema web a medida para Taller Mecánico Express · Nivel Avanzado.
TIPO DE PÁGINA: plataforma o sistema web a medida para empresa / operación (plataforma a medida).
...
SERVICIOS/OFERTA A MOSTRAR: servicio automotriz.
ESTRUCTURA ACORDADA CON EL CLIENTE: Panel, Clientes, Servicios, Reportes.
NEGOCIO: "Quiero un sistema a la medida de mi operación para controlar clientes, servicios y reportes".
...
- Negocio: Plataforma / sistema web a medida · Giro: Empresa / operación (plataforma a medida).
- Servicios/oferta: servicio automotriz.
- Descripción del cliente: "Quiero un sistema a la medida de mi operación para controlar clientes, servicios y reportes".
...
Incorpora la estructura acordada con el cliente: "Panel, Clientes, Servicios, Reportes".
...
- **Colores de marca**: 2-4 colores (hex) que usa el negocio (logo, redes, local); si no los hay, propón una paleta coherente con el giro **Empresa / operación (plataforma a medida)** y márcala como propuesta a validar.
...
- **Mensaje de venta:** Un sistema hecho a la medida de tu proceso: solo pagas los módulos que usas.
...
### Secciones a construir (Plataforma / sistema web a medida — 6 bloques)
- /login y /registro — Autenticación (si aplica).
- / — Dashboard principal con métricas.
- /[recurso] — Módulos del sistema (según el proceso del cliente): clientes, pedidos, inventario, reportes, etc.
- /[recurso]/[id] — Detalle/edición de registros.
...
- servicio automotriz — con descripción breve, beneficios y CTA de contacto.

### Sitemap / estructura acordada con el cliente
El cliente describió la estructura así: "Panel, Clientes, Servicios, Reportes". Asegúrate de que la navegación y las secciones reflejen esta estructura de forma completa y coherente.
...
Crea `docs/ux/voice-tone.md`: cómo suena la marca según el giro **Empresa / operación (plataforma a medida)** y el análisis (Un sistema hecho a la medida de tu proceso: solo pagas los módulos que usas.):
