> #️⃣ **REGISTRO · PK-024** — identifica este PACK en Vercel / GitHub
>
> | Campo | Valor |
> |---|---|
> | Código | `PK-024` |
...
> Este pack no es genérico: está afinado para un proyecto de **Plataforma de cursos en línea**. Toda decisión de UX, contenido, datos y QA debe alinearse con esto.

**🎭 Rol que conduce el proyecto:** Consultor educativo digital + arquitecto de plataforma de cursos

**🥇 Conversión #1 (el objetivo comercial):** Convertir visitas en ALUMNOS: el interesado ve el catálogo de cursos, se inscribe y avanza con lecciones en video, progreso y certificado — comunidad incluida si aplica.
...
PROYECTO: Plataforma de cursos en línea para Academia CursosPro · Nivel Avanzado.
TIPO DE PÁGINA: plataforma de cursos en línea (lecciones, progreso y certificados) para empresa / operación (plataforma a medida).
...
SERVICIOS/OFERTA A MOSTRAR: cursos de programación y diseño.
ESTRUCTURA ACORDADA CON EL CLIENTE: Inicio, Catálogo de cursos, Mi curso.
NEGOCIO: "Quiero una plataforma de cursos en línea con lecciones en video, progreso y certificados".
...
- Negocio: Plataforma de cursos en línea · Giro: Empresa / operación (plataforma a medida).
- Servicios/oferta: cursos de programación y diseño.
- Descripción del cliente: "Quiero una plataforma de cursos en línea con lecciones en video, progreso y certificados".
...
- **Mensaje de venta:** Vende cursos en línea con lecciones, progreso del alumno y certificados.
...
- cursos de programación y diseño — con descripción breve, beneficios y CTA de contacto.

### Sitemap / estructura acordada con el cliente
El cliente describió la estructura así: "Inicio, Catálogo de cursos, Mi curso". Asegúrate de que la navegación y las secciones reflejen esta estructura de forma completa y coherente.
...
Crea `docs/ux/voice-tone.md`: cómo suena la marca según el giro **Empresa / operación (plataforma a medida)** y el análisis (Vende cursos en línea con lecciones, progreso del alumno y certificados.):
