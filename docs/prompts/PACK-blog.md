> #️⃣ **REGISTRO · PK-009** — identifica este PACK en Vercel / GitHub
>
> | Campo | Valor |
> |---|---|
> | Código | `PK-009` |
...
| Tiempo estimado | 5-12 días de desarrollo |
...
> Este pack no es genérico: está afinado para un proyecto de **Blog / sitio de contenido con SEO**. Toda decisión de UX, contenido, datos y QA debe alinearse con esto.

**🎭 Rol que conduce el proyecto:** Editor de contenido + especialista SEO

**🥇 Conversión #1 (el objetivo comercial):** Convertir búsquedas en LECTORES y suscriptores: contenido indexable, buena lectura en móvil y newsletter que capture correos.
...
PROYECTO: Blog / sitio de contenido con SEO para Nutrición Clara · Nivel Profesional.
TIPO DE PÁGINA: blog / sitio de contenido para marca personal / contenido.
...
SERVICIOS/OFERTA A MOSTRAR: nutrición y hábitos saludables.
ESTRUCTURA ACORDADA CON EL CLIENTE: Inicio, Blog, Artículo, Contacto.
NEGOCIO: "Quiero un blog para publicar artículos que me posicionen en Google y atraigan clientes".
...
- Negocio: Blog / sitio de contenido con SEO · Giro: Marca personal / contenido.
- Servicios/oferta: nutrición y hábitos saludables.
- Descripción del cliente: "Quiero un blog para publicar artículos que me posicionen en Google y atraigan clientes".
- Sin referencia de estilo definida.
- Presupuesto: 12000 · Entrega: para el próximo mes.
...
Incorpora la estructura acordada con el cliente: "Inicio, Blog, Artículo, Contacto".
...
Dibuja (en Markdown con flechas) el flujo de cada tarea crítica del giro **Blog o sitio de contenido**:
- **Tarea 1**: Lector llega desde Google (SEO) y encuentra artículos relevantes.
- **Tarea 2**: Navega por categorías y lee contenido con buena tipografía.
- **Tarea 3**: Puede suscribirse al boletín o contactar al autor.
- **Tarea 4**: El autor publica desde un panel sencillo (editor con preview).
...
- **Colores de marca**: 2-4 colores (hex) que usa el negocio (logo, redes, local); si no los hay, propón una paleta coherente con el giro **Marca personal / contenido** y márcala como propuesta a validar.
...
- **Mensaje de venta:** Publica artículos que posicionan en Google y atraen clientes orgánicos.
...
### Secciones a construir (Blog / sitio de contenido con SEO — 6 bloques)
- / — Home con artículos destacados.
- /blog — Lista de artículos con categorías y búsqueda.
- /blog/[slug] — Artículo completo con lectura óptima y autor.
- /acerca-de — Sobre el autor/marca.
...
- nutrición y hábitos saludables — con descripción breve, beneficios y CTA de contacto.

### Sitemap / estructura acordada con el cliente
El cliente describió la estructura así: "Inicio, Blog, Artículo, Contacto". Asegúrate de que la navegación y las secciones reflejen esta estructura de forma completa y coherente.
...
Crea `docs/ux/voice-tone.md`: cómo suena la marca según el giro **Marca personal / contenido** y el análisis (Publica artículos que posicionan en Google y atraen clientes orgánicos.):
...
```sql
-- BLOG — esquema base (convención de tipos; ajustar en kickoff)
...
- 1. Lector llega desde Google (SEO) y encuentra artículos relevantes.
- 2. Navega por categorías y lee contenido con buena tipografía.
- 3. Puede suscribirse al boletín o contactar al autor.
- 4. El autor publica desde un panel sencillo (editor con preview).
