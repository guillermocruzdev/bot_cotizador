> #️⃣ **REGISTRO · PK-010** — identifica este PACK en Vercel / GitHub
>
> | Campo | Valor |
> |---|---|
> | Código | `PK-010` |
...
| Tiempo estimado | 6-12 días de desarrollo |
...
> Este pack no es genérico: está afinado para un proyecto de **Sitio multilingüe (español + inglés con SEO por idioma)**. Toda decisión de UX, contenido, datos y QA debe alinearse con esto.
...
PROYECTO: Sitio multilingüe (español + inglés con SEO por idioma) para Tour Riviera Maya · Nivel Profesional.
TIPO DE PÁGINA: landing / página de presentación para turismo / negocio fronterizo.
...
SERVICIOS/OFERTA A MOSTRAR: tours y experiencias en la Riviera Maya.
ESTRUCTURA ACORDADA CON EL CLIENTE: Inicio, Tours, Nosotros, Contacto.
NEGOCIO: "Quiero mi web en español e inglés porque atiendo turistas y clientes de exportación".
...
- Negocio: Sitio multilingüe (español + inglés con SEO por idioma) · Giro: Turismo / negocio fronterizo.
- Servicios/oferta: tours y experiencias en la Riviera Maya.
- Descripción del cliente: "Quiero mi web en español e inglés porque atiendo turistas y clientes de exportación".
...
Incorpora la estructura acordada con el cliente: "Inicio, Tours, Nosotros, Contacto".
...
- **Colores de marca**: 2-4 colores (hex) que usa el negocio (logo, redes, local); si no los hay, propón una paleta coherente con el giro **Turismo / negocio fronterizo** y márcala como propuesta a validar.
...
- **Mensaje de venta:** Atiende turistas y clientes internacionales con SEO por idioma (hreflang).
...
### Secciones a construir (Sitio multilingüe (español + inglés con SEO por idioma) — 4 bloques)
- / — Página de inicio: hero con propuesta de valor, servicios, beneficios, testimonios (opcional), CTA de contacto.
- /#servicios — Sección de servicios anclada.
- /#contacto — Formulario de contacto + datos de la empresa + mapa (si aplica).
- /aviso-de-privacidad — Página legal obligatoria en México (LFPDPPP).
...
- tours y experiencias en la Riviera Maya — con descripción breve, beneficios y CTA de contacto.

### Sitemap / estructura acordada con el cliente
El cliente describió la estructura así: "Inicio, Tours, Nosotros, Contacto". Asegúrate de que la navegación y las secciones reflejen esta estructura de forma completa y coherente.
...
Crea `docs/ux/voice-tone.md`: cómo suena la marca según el giro **Turismo / negocio fronterizo** y el análisis (Atiende turistas y clientes internacionales con SEO por idioma (hreflang).):
...
- **RF-18** · [Media] Versión en inglés y español (u otros idiomas): selector de idioma, textos traducidos y SEO hreflang.
