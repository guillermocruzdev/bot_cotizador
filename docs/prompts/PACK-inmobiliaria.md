...
> | URL Vercel | https://nexora-inmobiliaria.vercel.app |
> | Repo GitHub | https://github.com/Nexora/pack-inmobiliaria |
...
> Este pack no es genérico: está afinado para un proyecto de **Portal inmobiliario (propiedades, filtros y leads)**. Toda decisión de UX, contenido, datos y QA debe alinearse con esto.

**🎭 Rol que conduce el proyecto:** Consultor inmobiliario digital + arquitecto de portal de propiedades

**🥇 Conversión #1 (el objetivo comercial):** Convertir visitas en LEADS por propiedad: el interesado filtra por zona y precio, ve cada propiedad y deja su dato — cada anuncio genera contactos de compradores reales.
...
PROYECTO: Portal inmobiliario (propiedades, filtros y leads) para Inmobiliaria Horizonte · Nivel Avanzado.
TIPO DE PÁGINA: portal inmobiliario (propiedades, filtros por zona/precio y leads) para agencia inmobiliaria.
...
SERVICIOS/OFERTA A MOSTRAR: venta y renta de casas y departamentos.
ESTRUCTURA ACORDADA CON EL CLIENTE: Inicio, Propiedades, Detalle de propiedad, Panel.
NEGOCIO: "Quiero un portal con propiedades, filtros por zona y precio, y que cada propiedad genere leads".
...
- Negocio: Portal inmobiliario (propiedades, filtros y leads) · Giro: Agencia inmobiliaria.
- Servicios/oferta: venta y renta de casas y departamentos.
- Descripción del cliente: "Quiero un portal con propiedades, filtros por zona y precio, y que cada propiedad genere leads".
- Sin referencia de estilo definida.
- Presupuesto: 50000 · Entrega: para el próximo mes.
- Contexto técnico: usuarios con cuenta, sin pagos en línea, panel interno, sin asistentes IA.
...
- **Colores de marca**: 2-4 colores (hex) que usa el negocio (logo, redes, local); si no los hay, propón una paleta coherente con el giro **Agencia inmobiliaria** y márcala como propuesta a validar.
...
- **Mensaje de venta:** Cada propiedad genera leads de compradores reales, con filtros y panel.
...
- venta y renta de casas y departamentos — con descripción breve, beneficios y CTA de contacto.

### Sitemap / estructura acordada con el cliente
El cliente describió la estructura así: "Inicio, Propiedades, Detalle de propiedad, Panel". Asegúrate de que la navegación y las secciones reflejen esta estructura de forma completa y coherente.
...
Crea `docs/ux/voice-tone.md`: cómo suena la marca según el giro **Agencia inmobiliaria** y el análisis (Cada propiedad genera leads de compradores reales, con filtros y panel.):
