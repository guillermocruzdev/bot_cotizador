> #️⃣ **REGISTRO · PK-008** — identifica este PACK en Vercel / GitHub
>
> | Campo | Valor |
> |---|---|
> | Código | `PK-008` |
...
> Este pack no es genérico: está afinado para un proyecto de **Página de presentación para barbería (landing)**. Toda decisión de UX, contenido, datos y QA debe alinearse con esto.
...
SERVICIOS/OFERTA A MOSTRAR: corte clásico, barba y afeitado.
ESTRUCTURA ACORDADA CON EL CLIENTE: Inicio, Servicios, Galería, Ubicación, Contacto.
NEGOCIO: "Tengo una barbería y quiero que la gente me encuentre en Google y me escriba por WhatsApp".
...
- Negocio: Página de presentación para barbería (landing) · Giro: Barbería.
- Servicios/oferta: corte clásico, barba y afeitado.
- Descripción del cliente: "Tengo una barbería y quiero que la gente me encuentre en Google y me escriba por WhatsApp".
- Sin referencia de estilo definida.
- Presupuesto: 12000 a 15000 · Entrega: para el próximo mes.
...
Incorpora la estructura acordada con el cliente: "Inicio, Servicios, Galería, Ubicación, Contacto".
...
- **Colores de marca**: 2-4 colores (hex) que usa el negocio (logo, redes, local); si no los hay, propón una paleta coherente con el giro **Barbería** y márcala como propuesta a validar.
...
- **Mensaje de venta:** Una barbería que aparece en Google y recibe WhatsApp sin fricción.
...
### Secciones a construir (Página de presentación para barbería (landing) — 4 bloques)
- / — Página de inicio: hero con propuesta de valor, servicios, beneficios, testimonios (opcional), CTA de contacto.
- /#servicios — Sección de servicios anclada.
- /#contacto — Formulario de contacto + datos de la empresa + mapa (si aplica).
- /aviso-de-privacidad — Página legal obligatoria en México (LFPDPPP).
...
- corte clásico — con descripción breve, beneficios y CTA de contacto.
- barba y afeitado — con descripción breve, beneficios y CTA de contacto.

### Sitemap / estructura acordada con el cliente
El cliente describió la estructura así: "Inicio, Servicios, Galería, Ubicación, Contacto". Asegúrate de que la navegación y las secciones reflejen esta estructura de forma completa y coherente.
...
Crea `docs/ux/voice-tone.md`: cómo suena la marca según el giro **Barbería** y el análisis (Una barbería que aparece en Google y recibe WhatsApp sin fricción.):
