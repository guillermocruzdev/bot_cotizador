...
> | URL Vercel | https://nexora-link-in-bio.vercel.app |
> | Repo GitHub | https://github.com/Nexora/pack-link-in-bio |
...
| Fecha de entrega acordada | para la próxima semana |
| Mantenimiento | No incluido (opcional) |
| Asistentes IA (bots) | No incluidos |

### 🎯 Punto de partida según el tipo de servicio

> Este pack no es genérico: está afinado para un proyecto de **Página de enlaces (link-in-bio)**. Toda decisión de UX, contenido, datos y QA debe alinearse con esto.

**🎭 Rol que conduce el proyecto:** Estratega de marca personal / creador de contenido

**🥇 Conversión #1 (el objetivo comercial):** Convertir cada visita desde tu bio en una ACCIÓN concreta (seguir, WhatsApp, ver catálogo, agendar): un solo link que ordena tus enlaces y hace que la gente actúe.
...
PROYECTO: Página de enlaces (link-in-bio) para Sofía Creativa · Nivel Básico.
TIPO DE PÁGINA: página de enlaces (link-in-bio) para creador de contenido.
...
SERVICIOS/OFERTA A MOSTRAR: asesorías de marca y contenido.
ESTRUCTURA ACORDADA CON EL CLIENTE: Enlaces, Mini-catálogo, Contacto.
NEGOCIO: "Quiero una página con mis enlaces para poner en mi bio de Instagram".
...
- Negocio: Página de enlaces (link-in-bio) · Giro: Creador de contenido.
- Servicios/oferta: asesorías de marca y contenido.
- Descripción del cliente: "Quiero una página con mis enlaces para poner en mi bio de Instagram".
- Sin referencia de estilo definida.
- Presupuesto: 5000 · Entrega: para la próxima semana.
...
Incorpora la estructura acordada con el cliente: "Enlaces, Mini-catálogo, Contacto".
...
Dibuja (en Markdown con flechas) el flujo de cada tarea crítica del giro **Página de enlaces (link-in-bio)**:
...
- **Colores de marca**: 2-4 colores (hex) que usa el negocio (logo, redes, local); si no los hay, propón una paleta coherente con el giro **Creador de contenido** y márcala como propuesta a validar.
...
- **Mensaje de venta:** Un solo link en tu bio que ordena tus enlaces y hace que la gente actúe.
...
### Secciones a construir (Página de enlaces (link-in-bio) — 4 bloques)
- / — Página de inicio: hero con propuesta de valor, servicios, beneficios, testimonios (opcional), CTA de contacto.
- /#servicios — Sección de servicios anclada.
- /#contacto — Formulario de contacto + datos de la empresa + mapa (si aplica).
- /aviso-de-privacidad — Página legal obligatoria en México (LFPDPPP).
...
- asesorías de marca y contenido — con descripción breve, beneficios y CTA de contacto.

### Sitemap / estructura acordada con el cliente
El cliente describió la estructura así: "Enlaces, Mini-catálogo, Contacto". Asegúrate de que la navegación y las secciones reflejen esta estructura de forma completa y coherente.
...
Crea `docs/ux/voice-tone.md`: cómo suena la marca según el giro **Creador de contenido** y el análisis (Un solo link en tu bio que ordena tus enlaces y hace que la gente actúe.):
...
```sql
-- LINK_IN_BIO — esquema base (convención de tipos; ajustar en kickoff)
