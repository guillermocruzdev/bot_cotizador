...
> Este pack no es genérico: está afinado para un proyecto de **Sistema de Citas para Consultorio Dental**. Toda decisión de UX, contenido, datos y QA debe alinearse con esto.

**🎭 Rol que conduce el proyecto:** Product Manager de servicios + diseñador de flujo de agenda

**🥇 Conversión #1 (el objetivo comercial):** Convertir interés en CITA AGENDADA sin llamadas: elegir servicio → día → hora → confirmación. Bloquear horarios para evitar dobles reservas.
...
PROYECTO: Sistema de Citas para Consultorio Dental para Dra. Laura Gómez · Nivel Avanzado.
TIPO DE PÁGINA: sistema de citas y reservaciones para consultorio dental.
...
SERVICIOS/OFERTA A MOSTRAR: limpieza dental, ortodoncia y blanqueamiento.
ESTRUCTURA ACORDADA CON EL CLIENTE: Inicio, Servicios, Agenda, Panel, Contacto.
NEGOCIO: "Soy dentista en Madero, quiero que mis pacientes agenden citas online".
...
- Negocio: Sistema de Citas para Consultorio Dental · Giro: Consultorio dental.
- Servicios/oferta: limpieza dental, ortodoncia y blanqueamiento.
- Descripción del cliente: "Soy dentista en Madero, quiero que mis pacientes agenden citas online".
- Sin referencia de estilo definida.
- Presupuesto: 20000 · Entrega: para el próximo mes.
- Contexto técnico: sin cuentas, sin pagos en línea, panel interno, sin asistentes IA.
...
Incorpora la estructura acordada con el cliente: "Inicio, Servicios, Agenda, Panel, Contacto".
...
- **Colores de marca**: 2-4 colores (hex) que usa el negocio (logo, redes, local); si no los hay, propón una paleta coherente con el giro **Consultorio dental** y márcala como propuesta a validar.
...
- **Mensaje de venta:** La web es tu recepcionista 24/7: agenda citas mientras atiendes.
...
### Secciones a construir (Sistema de Citas para Consultorio Dental — 6 bloques)
- / — Home: presentación del consultorio/negocio, servicios y CTA de agendar.
- /servicios — Lista de servicios con precios y duración.
- /agendar — Calendario + selección de día y hora para el servicio elegido.
- /confirmacion — Confirmación de cita con resumen.
...
- limpieza dental — con descripción breve, beneficios y CTA de contacto.
- ortodoncia y blanqueamiento — con descripción breve, beneficios y CTA de contacto.

### Sitemap / estructura acordada con el cliente
El cliente describió la estructura así: "Inicio, Servicios, Agenda, Panel, Contacto". Asegúrate de que la navegación y las secciones reflejen esta estructura de forma completa y coherente.
...
Crea `docs/ux/voice-tone.md`: cómo suena la marca según el giro **Consultorio dental** y el análisis (La web es tu recepcionista 24/7: agenda citas mientras atiendes.):
