> #️⃣ **REGISTRO · PK-027** — identifica este PACK en Vercel / GitHub
>
> | Campo | Valor |
> |---|---|
> | Código | `PK-027` |
...
| Tiempo estimado | 45-60 días de desarrollo |
...
> Este pack no es genérico: está afinado para un proyecto de **Software como servicio (SaaS) multi-tenant**. Toda decisión de UX, contenido, datos y QA debe alinearse con esto.
...
PROYECTO: Software como servicio (SaaS) multi-tenant para NubeContable · Nivel Avanzado.
...
ESTRUCTURA ACORDADA CON EL CLIENTE: Landing del SaaS, Panel, Configuración.
NEGOCIO: "Quiero un software como servicio para que mis clientes lleven su contabilidad con planes y pago mensual".
...
- Negocio: Software como servicio (SaaS) multi-tenant · Giro: Empresa / operación (plataforma a medida).
- Servicios/oferta: contabilidad en línea para pymes.
- Descripción del cliente: "Quiero un software como servicio para que mis clientes lleven su contabilidad con planes y pago mensual".
- Sin referencia de estilo definida.
- Presupuesto: 100000 · Entrega: para el próximo mes.
...
- **Mensaje de venta:** Tu software para muchos clientes, con datos aislados y cobro de plan mensual.
...
- contabilidad en línea para pymes — con descripción breve, beneficios y CTA de contacto.

### Sitemap / estructura acordada con el cliente
El cliente describió la estructura así: "Landing del SaaS, Panel, Configuración". Asegúrate de que la navegación y las secciones reflejen esta estructura de forma completa y coherente.
...
Crea `docs/ux/voice-tone.md`: cómo suena la marca según el giro **Empresa / operación (plataforma a medida)** y el análisis (Tu software para muchos clientes, con datos aislados y cobro de plan mensual.):
