> #️⃣ **REGISTRO · PK-011** — identifica este PACK en Vercel / GitHub
>
> | Campo | Valor |
> |---|---|
> | Código | `PK-011` |
...
| Tiempo estimado | 7-15 días de desarrollo |
...
> Este pack no es genérico: está afinado para un proyecto de **Web instalable (PWA) con notificaciones**. Toda decisión de UX, contenido, datos y QA debe alinearse con esto.
...
PROYECTO: Web instalable (PWA) con notificaciones para Pizzería La Flama · Nivel Profesional.
TIPO DE PÁGINA: landing / página de presentación para restaurante / negocio local.
...
SERVICIOS/OFERTA A MOSTRAR: pizza artesanal a domicilio.
ESTRUCTURA ACORDADA CON EL CLIENTE: Inicio, Menú, Pedido, Contacto.
NEGOCIO: "Quiero que mi web se instale en el celular de mis clientes como app con notificaciones".
...
- Negocio: Web instalable (PWA) con notificaciones · Giro: Restaurante / negocio local.
- Servicios/oferta: pizza artesanal a domicilio.
- Descripción del cliente: "Quiero que mi web se instale en el celular de mis clientes como app con notificaciones".
...
Incorpora la estructura acordada con el cliente: "Inicio, Menú, Pedido, Contacto".
...
- **Colores de marca**: 2-4 colores (hex) que usa el negocio (logo, redes, local); si no los hay, propón una paleta coherente con el giro **Restaurante / negocio local** y márcala como propuesta a validar.
...
- **Mensaje de venta:** Tus clientes instalan tu web como app sin pasar por la tienda y reciben notificaciones.
...
### Secciones a construir (Web instalable (PWA) con notificaciones — 4 bloques)
- / — Página de inicio: hero con propuesta de valor, servicios, beneficios, testimonios (opcional), CTA de contacto.
- /#servicios — Sección de servicios anclada.
- /#contacto — Formulario de contacto + datos de la empresa + mapa (si aplica).
- /aviso-de-privacidad — Página legal obligatoria en México (LFPDPPP).
...
- pizza artesanal a domicilio — con descripción breve, beneficios y CTA de contacto.

### Sitemap / estructura acordada con el cliente
El cliente describió la estructura así: "Inicio, Menú, Pedido, Contacto". Asegúrate de que la navegación y las secciones reflejen esta estructura de forma completa y coherente.
...
Crea `docs/ux/voice-tone.md`: cómo suena la marca según el giro **Restaurante / negocio local** y el análisis (Tus clientes instalan tu web como app sin pasar por la tienda y reciben notificaciones.):
