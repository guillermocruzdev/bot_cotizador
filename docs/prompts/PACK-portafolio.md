> #️⃣ **REGISTRO · PK-007** — identifica este PACK en Vercel / GitHub
>
> | Campo | Valor |
> |---|---|
> | Código | `PK-007` |
...
| Tiempo estimado | 4-10 días de desarrollo |
...
> Este pack no es genérico: está afinado para un proyecto de **Portafolio profesional (galería con animaciones)**. Toda decisión de UX, contenido, datos y QA debe alinearse con esto.

**🎭 Rol que conduce el proyecto:** Diseñador de portafolio + narrador visual

**🥇 Conversión #1 (el objetivo comercial):** Convertir visitas en CONTACTO de clientes/empleadores: que la especialidad se entienda en segundos y los casos de estudio cierren con un CTA.
...
PROYECTO: Portafolio profesional (galería con animaciones) para Mariana Fotógrafa · Nivel Profesional.
TIPO DE PÁGINA: portafolio profesional para fotógrafo / creativo.
...
SERVICIOS/OFERTA A MOSTRAR: fotografía de bodas y retratos.
ESTRUCTURA ACORDADA CON EL CLIENTE: Inicio, Portafolio, Sobre mí, Contacto.
NEGOCIO: "Quiero un portafolio para mostrar mi trabajo con galería y animaciones".
...
- Negocio: Portafolio profesional (galería con animaciones) · Giro: Fotógrafo / creativo.
- Servicios/oferta: fotografía de bodas y retratos.
- Descripción del cliente: "Quiero un portafolio para mostrar mi trabajo con galería y animaciones".
- Sin referencia de estilo definida.
- Presupuesto: 9000 · Entrega: para el próximo mes.
...
Incorpora la estructura acordada con el cliente: "Inicio, Portafolio, Sobre mí, Contacto".
...
Dibuja (en Markdown con flechas) el flujo de cada tarea crítica del giro **Portafolio profesional**:
- **Tarea 1**: Reclutador/cliente ve la portada y capta la especialidad en segundos.
- **Tarea 2**: Explora la galería de proyectos con transiciones suaves.
- **Tarea 3**: Abre un caso de estudio y ve el impacto del trabajo.
- **Tarea 4**: Contacta por formulario o WhatsApp directo.
...
- **Colores de marca**: 2-4 colores (hex) que usa el negocio (logo, redes, local); si no los hay, propón una paleta coherente con el giro **Fotógrafo / creativo** y márcala como propuesta a validar.
...
- **Mensaje de venta:** Tu trabajo en una galería con animaciones que deja huella y cierra proyectos.
...
### Secciones a construir (Portafolio profesional (galería con animaciones) — 5 bloques)
- / — Home: hero con tu propuesta, proyectos destacados y CTA.
- /proyectos — Galería completa con filtros por tipo.
- /proyectos/[slug] — Caso de estudio con imágenes y resultados.
- /contacto — Formulario + redes sociales + WhatsApp.
...
- fotografía de bodas y retratos — con descripción breve, beneficios y CTA de contacto.

### Sitemap / estructura acordada con el cliente
El cliente describió la estructura así: "Inicio, Portafolio, Sobre mí, Contacto". Asegúrate de que la navegación y las secciones reflejen esta estructura de forma completa y coherente.
...
Crea `docs/ux/voice-tone.md`: cómo suena la marca según el giro **Fotógrafo / creativo** y el análisis (Tu trabajo en una galería con animaciones que deja huella y cierra proyectos.):
...
```sql
-- PORTAFOLIO — esquema base (convención de tipos; ajustar en kickoff)
...
- 1. Reclutador/cliente ve la portada y capta la especialidad en segundos.
- 2. Explora la galería de proyectos con transiciones suaves.
- 3. Abre un caso de estudio y ve el impacto del trabajo.
- 4. Contacta por formulario o WhatsApp directo.
