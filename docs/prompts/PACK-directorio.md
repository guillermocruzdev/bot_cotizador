...
> Este pack no es genérico: está afinado para un proyecto de **Directorio de negocios (fichas y mapa)**. Toda decisión de UX, contenido, datos y QA debe alinearse con esto.

**🎭 Rol que conduce el proyecto:** Consultor de asociaciones/cámaras + arquitecto de directorio

**🥇 Conversión #1 (el objetivo comercial):** Convertir visitas en NEGOCIOS registrados y en CONSULTAS útiles: cada negocio tiene su ficha autogestionable, el visitante busca por categoría/mapa y encuentra a quién contactar.
...
PROYECTO: Directorio de negocios (fichas y mapa) para Cámara de Comercio Local · Nivel Avanzado.
TIPO DE PÁGINA: directorio de negocios (fichas autogestionables, búsqueda y mapa) para empresa / operación (plataforma a medida).
...
SERVICIOS/OFERTA A MOSTRAR: asociados del comercio local.
ESTRUCTURA ACORDADA CON EL CLIENTE: Inicio, Directorio, Ficha de negocio, Panel.
NEGOCIO: "Quiero un directorio de negocios con fichas autogestionables y búsqueda por categoría y mapa".
...
- Negocio: Directorio de negocios (fichas y mapa) · Giro: Empresa / operación (plataforma a medida).
- Servicios/oferta: asociados del comercio local.
- Descripción del cliente: "Quiero un directorio de negocios con fichas autogestionables y búsqueda por categoría y mapa".
- Sin referencia de estilo definida.
- Presupuesto: 35000 · Entrega: para el próximo mes.
...
- **Mensaje de venta:** Cada negocio del directorio tiene su ficha autogestionable con búsqueda y mapa.
...
- asociados del comercio local — con descripción breve, beneficios y CTA de contacto.

### Sitemap / estructura acordada con el cliente
El cliente describió la estructura así: "Inicio, Directorio, Ficha de negocio, Panel". Asegúrate de que la navegación y las secciones reflejen esta estructura de forma completa y coherente.
...
Crea `docs/ux/voice-tone.md`: cómo suena la marca según el giro **Empresa / operación (plataforma a medida)** y el análisis (Cada negocio del directorio tiene su ficha autogestionable con búsqueda y mapa.):
