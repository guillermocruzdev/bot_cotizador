> #️⃣ **REGISTRO · PK-003** — identifica este PACK en Vercel / GitHub
>
> | Campo | Valor |
> |---|---|
> | Código | `PK-003` |
...
| Tiempo estimado | 2-4 días de desarrollo |
...
> Este pack no es genérico: está afinado para un proyecto de **Tarjeta digital / minisitio**. Toda decisión de UX, contenido, datos y QA debe alinearse con esto.

**🎭 Rol que conduce el proyecto:** Diseñador de marca personal / minisitio de presentación

**🥇 Conversión #1 (el objetivo comercial):** Convertir cada tarjeta compartida por WhatsApp en CONOCIMIENTO y CONTACTO: quien la recibe entiende en segundos qué haces, te ubica y te contacta con un toque.
...
PROYECTO: Tarjeta digital / minisitio para Pedro Ramírez · Nivel Básico.
TIPO DE PÁGINA: tarjeta digital / minisitio para fotógrafo / creativo.
...
SERVICIOS/OFERTA A MOSTRAR: fotografía de eventos y retratos.
ESTRUCTURA ACORDADA CON EL CLIENTE: Presentación, Servicios, Galería, Ubicación, Contacto.
NEGOCIO: "Quiero una tarjeta digital para compartir mi información por WhatsApp".
...
- Negocio: Tarjeta digital / minisitio · Giro: Fotógrafo / creativo.
- Servicios/oferta: fotografía de eventos y retratos.
- Descripción del cliente: "Quiero una tarjeta digital para compartir mi información por WhatsApp".
- Sin referencia de estilo definida.
- Presupuesto: 6000 · Entrega: para el próximo mes.
...
Incorpora la estructura acordada con el cliente: "Presentación, Servicios, Galería, Ubicación, Contacto".
...
Dibuja (en Markdown con flechas) el flujo de cada tarea crítica del giro **Tarjeta digital / minisitio**:
...
- **Mensaje de venta:** Tu información profesional en un solo link que se abre al tocar.
...
### Secciones a construir (Tarjeta digital / minisitio — 4 bloques)
- / — Página de inicio: hero con propuesta de valor, servicios, beneficios, testimonios (opcional), CTA de contacto.
- /#servicios — Sección de servicios anclada.
- /#contacto — Formulario de contacto + datos de la empresa + mapa (si aplica).
- /aviso-de-privacidad — Página legal obligatoria en México (LFPDPPP).
...
- fotografía de eventos y retratos — con descripción breve, beneficios y CTA de contacto.

### Sitemap / estructura acordada con el cliente
El cliente describió la estructura así: "Presentación, Servicios, Galería, Ubicación, Contacto". Asegúrate de que la navegación y las secciones reflejen esta estructura de forma completa y coherente.
...
Crea `docs/ux/voice-tone.md`: cómo suena la marca según el giro **Fotógrafo / creativo** y el análisis (Tu información profesional en un solo link que se abre al tocar.):
...
```sql
-- TARJETA_DIGITAL — esquema base (convención de tipos; ajustar en kickoff)
