...
> Este pack no es genérico: está afinado para un proyecto de **Menú digital con código QR**. Toda decisión de UX, contenido, datos y QA debe alinearse con esto.

**🎭 Rol que conduce el proyecto:** Consultor gastronómico + diseñador de menú digital

**🥇 Conversión #1 (el objetivo comercial):** Convertir el escaneo del QR en PEDIDO o contacto: que el comensal vea la carta en su celular, elija y pida por WhatsApp (o llame), sin esperar mesero ni buscar el menú en físico.
...
PROYECTO: Menú digital con código QR para Taquería El Pastor · Nivel Básico.
TIPO DE PÁGINA: menú digital con código QR para restaurante / negocio de comida.
...
SERVICIOS/OFERTA A MOSTRAR: tacos, tortas, quesadillas y aguas frescas.
ESTRUCTURA ACORDADA CON EL CLIENTE: Menú, Promociones, Cómo pedir, Contacto.
NEGOCIO: "Quiero un menú con código QR para que mis clientes escaneen y vean mi carta en la mesa".
...
- Negocio: Menú digital con código QR · Giro: Restaurante / negocio de comida.
- Servicios/oferta: tacos, tortas, quesadillas y aguas frescas.
- Descripción del cliente: "Quiero un menú con código QR para que mis clientes escaneen y vean mi carta en la mesa".
- Sin referencia de estilo definida.
- Presupuesto: 6000 a 9000 · Entrega: para el próximo mes.
...
Incorpora la estructura acordada con el cliente: "Menú, Promociones, Cómo pedir, Contacto".
...
Dibuja (en Markdown con flechas) el flujo de cada tarea crítica del giro **Menú digital con código QR**:
...
- **Mensaje de venta:** Cada mesa escanea el QR y ve tu carta al instante, sin esperar mesero.
...
### Secciones a construir (Menú digital con código QR — 4 bloques)
- / — Página de inicio: hero con propuesta de valor, servicios, beneficios, testimonios (opcional), CTA de contacto.
- /#servicios — Sección de servicios anclada.
- /#contacto — Formulario de contacto + datos de la empresa + mapa (si aplica).
- /aviso-de-privacidad — Página legal obligatoria en México (LFPDPPP).
...
- tacos — con descripción breve, beneficios y CTA de contacto.
- tortas — con descripción breve, beneficios y CTA de contacto.
- quesadillas y aguas frescas — con descripción breve, beneficios y CTA de contacto.

### Sitemap / estructura acordada con el cliente
El cliente describió la estructura así: "Menú, Promociones, Cómo pedir, Contacto". Asegúrate de que la navegación y las secciones reflejen esta estructura de forma completa y coherente.
...
Crea `docs/ux/voice-tone.md`: cómo suena la marca según el giro **Restaurante / negocio de comida** y el análisis (Cada mesa escanea el QR y ve tu carta al instante, sin esperar mesero.):
...
```sql
-- MENU_DIGITAL — esquema base (convención de tipos; ajustar en kickoff)
