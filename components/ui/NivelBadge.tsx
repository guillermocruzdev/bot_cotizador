...
const NIVEL_STYLES: Record<string, string> = {
  N0: "bg-slate-100 text-slate-700 ring-slate-300",
  N1: "bg-blue-50 text-blue-700 ring-blue-200",
  N2: "bg-brand-600/10 text-brand-700 ring-brand-600/30",
  N3: "bg-emerald-50 text-emerald-700 ring-emerald-500/30",
  N4: "bg-indigo-50 text-indigo-700 ring-indigo-200",
  N5: "bg-night-900 text-white ring-night-900",
};
  ...
  return (
    <span
      className={cn(
        ...
        NIVEL_STYLES[key] ?? "bg-slate-100 text-slate-700 ring-slate-300",
        className
      )}
    >
      {key}
