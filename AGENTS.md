...
**Flujo consolidado (menos preguntas):** para landing/portafolio/blog se SALTAN cuentas y BD (`technical_auth`/`technical_db`); `budget` pregunta fecha Y monto en un solo turno (si el cliente da solo uno, `clarify_budget` afina el que falta, máx 2); `contact_name` pide nombre + correo + WhatsApp en un solo mensaje (`contact_email`/`contact_phone` quedan como seguimientos si falta algo). Cierre: `budget → contact_name → (contact_email → contact_phone si falta) → extra_comments`.
...
| Módulo                                                  | Rol                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| ------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `conversation-flow.ts`                                  | Árbol de nodos del chat + `extractSignals`/`extractSections`/`extractBudgetAmount`/`extractDeadline`/`captureEarlyData` (parseo de intención, presupuesto, plazo, estructura web). Flujo consolidado: `budget` fusiona fecha+monto, `contact_name` pide los 3 datos de contacto, y cuentas/BD se saltan para landing/portafolio/blog.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
